package com.hack23.riksdagsmonitor.views;

import com.hack23.riksdagsmonitor.data.entity.User;
import com.hack23.riksdagsmonitor.security.AuthenticatedUser;
import com.hack23.riksdagsmonitor.views.about.AboutView;
import com.hack23.riksdagsmonitor.views.dashboard.DashboardView;
import com.hack23.riksdagsmonitor.views.userprofile.UserProfileView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        H1 appName = new H1("Riksdagsmonitor");
    ...
    private MenuItemInfo[] createMenuItems() {
        return new MenuItemInfo[]{ //
                new MenuItemInfo("Dashboard", "la la-th-list", DashboardView.class), //

                new MenuItemInfo("About", "la la-file", AboutView.class), //

                new MenuItemInfo("User Profile", "la la-user", UserProfileView.class), //
